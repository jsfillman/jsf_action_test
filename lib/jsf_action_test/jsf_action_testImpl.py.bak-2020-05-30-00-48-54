...
This sample module contains one small method that filters contigs.
    ...
    def run_jsf_action_test(self, ctx, params):
        """
        ...
        #BEGIN run_jsf_action_test

        # Print statements to stdout/stderr are captured and available as the App log
        logging.info('Starting run_jsf_action_test function. Params=' + pformat(params))
        ...
        #END run_jsf_action_test

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_jsf_action_test return value ' +
